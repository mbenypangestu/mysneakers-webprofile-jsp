<%-- 
    Document   : register
    Created on : May 8, 2018, 12:57:41 PM
    Author     : dell
--%>
...
<head>
  ...
  <title>My Sneaker SBY | Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>My Sneaker </b>SBY</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <a href="${pageContext.request.contextPath}/login" class="text-center">I already have a membership</a><br>
