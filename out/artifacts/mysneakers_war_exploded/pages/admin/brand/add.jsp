...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Tambah Brand
                <small>Penambahan data brand</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/administrator/brand/add">
                            <div class="box-body pad">
                                <div class="form-group">
                                    <label for="nama" class="col-sm-2 control-label">Nama Brand (*)</label>

                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Brand">
                                    </div>
                                </div>
                            </div>
