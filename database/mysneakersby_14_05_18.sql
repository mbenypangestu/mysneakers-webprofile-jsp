...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2018 at 05:59 AM
...
INSERT INTO `produk` (`id`, `brand_id`, `nama`, `deskripsi`, `gambar`, `jenis_id`, `bahan`, `harga`, `stok`) VALUES
...
INSERT INTO `user` (`id`, `nama`, `username`, `email`, `password`, `remember_token`, `alamat`, `telp`, `foto`) VALUES
